  ...
  return (
   <div className='p-3 max-w-lg mx-auto'>
    ...
    <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
      ...
      <img onClick={()=> fileRef.current.click()} src={formData.avatar||currentUser.avaatar} alt="profile" className='rounded-full h-24 w-24 object-cover cursor-pointer self-center mt-2' />
    ...
    {userListings && userListings.length > 0 && (
        <div className='flex flex-col gap-4'>
          ...
          {userListings.map((listing) => (
            <div
              key={listing._id}
              className='border rounded-lg p-3 flex justif y-between items-center gap-4'
            >
